...
function initDashboardEngine() {
    document.getElementById('addWorkRow').onclick = () => addDashboardRow();
...
function initSummaryEngine() { document.getElementById('addSummaryRow').onclick = () => addSummaryItem(); }
...
function initDetailedProgress() { document.querySelector('[data-table="progressTableBody"]').onclick = () => addTableRow('progressTableBody'); }
function initQualityManageModule() { document.querySelector('[data-table="qualityTableBody"]').onclick = () => addTableRow('qualityTableBody', ["主题", "问题", "解决"]); }
function initRiskManageModule() { document.querySelector('[data-table="riskTableBody"]').onclick = () => addTableRow('riskTableBody', ["描述", "解决", "执行方", "最后期限", "状态"]); }
...
function initMaterialModule() { document.getElementById('addMaterialSection').onclick = () => createMediaSection('materialSectionsContainer'); }
...
function initSiteIssueModule() { document.getElementById('addComparisonRow').onclick = () => addComparisonRow(); }

// --- PDF 逻辑 ---
function initCostModule() {
    const input = document.getElementById('pdfInput'), grid = document.getElementById('pdfGrid');
    document.getElementById('pdfTrigger').onclick = () => input.click();
    ...
    document.getElementById('addCostNoteRow').onclick = () => {
...
function collectAllReportData() {
    ...
    return {
        header: { project: document.getElementById('projectName').innerText, reportNo: document.getElementById('reportNo').innerText, reportDate: document.getElementById('reportDate').innerText, pm: document.getElementById('pmName').innerText, client: document.getElementById('clientName').innerText, addr: document.getElementById('projAddress').innerText, reporter: document.getElementById('reporterName').innerText, start: document.getElementById('startDate').value, end: document.getElementById('endDate').value },
        dashboard: { total: document.getElementById('totalDays').innerText, worked: document.getElementById('workedDays').innerText, workers: document.getElementById('workerNum').innerText, base: document.getElementById('baseContract').value, add: document.getElementById('addContract').value, workItems: getList('#workList .bar-row').map(r => ({ n: r.querySelector('.bar-name').innerText, p: r.querySelector('.bar-input').value })) },
...
function restoreReportFromData(data) {
    ...
    try {
        const h = data.header;
        document.getElementById('projectName').innerText = h.project; document.getElementById('reportNo').innerText = h.reportNo; document.getElementById('reportDate').innerText = h.reportDate; document.getElementById('pmName').innerText = h.pm; document.getElementById('clientName').innerText = h.client; document.getElementById('projAddress').innerText = h.addr; document.getElementById('reporterName').innerText = h.reporter; document.getElementById('startDate').value = h.start; document.getElementById('endDate').value = h.end;
        const d = data.dashboard;
        document.getElementById('totalDays').innerText = d.total; document.getElementById('workedDays').innerText = d.worked; document.getElementById('workerNum').innerText = d.workers; document.getElementById('baseContract').value = d.base; document.getElementById('addContract').value = d.add;
        document.getElementById('workList').innerHTML = ''; d.workItems.forEach(it => addDashboardRow(it.n, it.p));
        document.getElementById('summaryItemsContainer').innerHTML = ''; data.summaries.forEach(it => addSummaryItem(it.t, it.c));
        document.getElementById('progressTableBody').innerHTML = ''; data.progressTable.forEach(row => addTableRow('progressTableBody', row));
        document.getElementById('qualityTableBody').innerHTML = ''; data.qualityTable.forEach(row => addTableRow('qualityTableBody', row));
        document.getElementById('riskTableBody').innerHTML = ''; data.riskTable.forEach(row => addTableRow('riskTableBody', row));
